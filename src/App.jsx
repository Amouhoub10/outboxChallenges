...
function NavigationBanner() {
  ...
  return (
    <div className="nav-banner" style={{ position: 'fixed', bottom: '24px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(17, 24, 39, 0.85)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', padding: '6px', borderRadius: '999px', display: 'flex', gap: '4px', fontSize: '13px', fontFamily: 'Inter, sans-serif', zIndex: 9999, border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 10px 40px rgba(0,0,0,0.3)' }}>
      <Link
        to="/"
